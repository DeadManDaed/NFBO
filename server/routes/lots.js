...
const pool = require('../db'); // pour insertion lot si nécessaire

// Option A : on reçoit un lot déjà inséré (lot_id)
router.post('/admit-by-id', validateLot, async (req, res) => {
  try {
...
// Option B : on reçoit les champs du lot, on crée le lot puis on appelle la fonction stockée
